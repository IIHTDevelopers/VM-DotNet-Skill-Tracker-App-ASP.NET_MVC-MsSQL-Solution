...
namespace SkillTrackerApp.Tests.TestCases
{
    public class ExceptionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Skill_ById_NotNull()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Skill_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Skill_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                skilltrackerskill.Setup(repos => repos.DeleteSkill(_Skill.Id)).Returns(id);
        ...
        [Fact]
        public async Task<bool> Testfor_GetAll_Skill_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Invalid_SkillName_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Invalid_SkillNote_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
